...
const Home = () => {
  ...
  useEffect(() => {
    const fetchToken = async () => {
      ...
      await fetchEmbedUrl({ reportId: "5dd47363-29f8-4984-90d4-2c7e7fc947c5", workspaceId: "d98dbbf9-63bf-4c37-ac97-584e3997a220", accessToken: data.accessToken })
      const token = await generateEmbedToken({ reportId: "5dd47363-29f8-4984-90d4-2c7e7fc947c5", workspaceId: "d98dbbf9-63bf-4c37-ac97-584e3997a220", datasetId: "92d1baa2-a11a-4d28-baa6-c44b3d50a68d", accessToken: data.accessToken });
